...
- Codex retries models rejected by ChatGPT account access or older CLI versions with gpt-5.6-sol.
- Copilot retries unavailable selected models using its automatic model selection.
...
### Added
- Added support for handling cross-workspace dependencies and plugin manifests in release process

### Changed
- Updated github/codeql-action/analyze to 4.37.3
